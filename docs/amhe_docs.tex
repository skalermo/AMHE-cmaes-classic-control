...
\begin{table}[!h]
  \centering
  \hskip-1.0cm\begin{tabular}{llllr}
    \hline
    \multicolumn{1}{c}{}     & \multicolumn{1}{c}{A2C}         & \multicolumn{1}{c}{PPO}         & \multicolumn{1}{c}{CMAESNN}              & \multicolumn{1}{c}{} \\
    \hline
    CartPole-v0              & \phantom{$-$}$181.28 \pm 40.90$ & \phantom{$-$}\bm{$200 \pm 0.0}$ & \phantom{\bm{$-$}}$199.7 \pm 2.1$        &                      \\
    CartPole-v1              & \phantom{$-$}$500 \pm 0.0$      & \phantom{$-$}$500 \pm 0.0$      & \phantom{\bm{$-$}}\bm{$500 \pm 0.0$}     &                      \\
    MountainCar-v0           & $-200  \pm 0.0$                 & $-200 \pm 0.0$                  & \bm{$-125.82 \pm 33.43} $                &                      \\
    MountainCarContinuous-v0 & $-0.01 \pm 0.02$                & \phantom{$-$}$0.0 \pm 0.0$      & \phantom{\bm{$-$}}\bm{$49.57 \pm 49.74$} &                      \\
